...
/**
 * Kafka 기반 Saga 패턴 통합 테스트
 */
class KafkaSagaIntegrationTest extends IntegrationTestBase {
    ...
    private OrderCreatedEvent createOrderCreatedEvent(Long orderId, String orderNumber) {
        List<OrderItemInfo> orderItems = List.of(
                new OrderItemInfo(1L, 1L, "상품1", "옵션1", 2, BigDecimal.valueOf(10000), BigDecimal.valueOf(20000))
        );
